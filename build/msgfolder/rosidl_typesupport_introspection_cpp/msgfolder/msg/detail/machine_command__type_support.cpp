...
{
  new (message_memory) msgfolder::msg::MachineCommand(_init);
}

void MachineCommand_fini_function(void * message_memory)
{
  auto typed_message = static_cast<msgfolder::msg::MachineCommand *>(message_memory);
  typed_message->~MachineCommand();
}

static const ::rosidl_typesupport_introspection_cpp::MessageMember MachineCommand_message_member_array[1] = {
  {
    "command",  // name
    ...
    offsetof(msgfolder::msg::MachineCommand, command),  // bytes offset in struct
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers MachineCommand_message_members = {
  ...
  1,  // number of fields
  sizeof(msgfolder::msg::MachineCommand),
...
{
  return &::msgfolder::msg::rosidl_typesupport_introspection_cpp::MachineCommand_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, msgfolder, msg, MachineCommand)() {
  return &::msgfolder::msg::rosidl_typesupport_introspection_cpp::MachineCommand_message_type_support_handle;
}
